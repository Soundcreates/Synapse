...
router.get(
  "/datasets/owner/:ownerAddress",
  dataSetControlller_1.getDataSetByIdOrOwner,
);
...
router.post(
  "/datasets/:dataSetId/get-pool-id",
  dataSetControlller_1.getBlockchainPoolId,
);
router.patch(
  "/datasets/:dataSetId/confirm-purchase",
  dataSetControlller_1.confirmPurchase,
);
