    ...
    try {
        ...
        if (error instanceof Error) {
            if (error.message.includes("ENOTFOUND")) {
                ...
                console.log("💡 Tip: Check your DB_USER and DB_PASSWORD environment variables");
            }
            else if (error.message.includes("database") &&
                error.message.includes("does not exist")) {
                console.log("💡 Tip: Check your DB_NAME environment variable or create the database");
            }
        }
    }
    finally {
